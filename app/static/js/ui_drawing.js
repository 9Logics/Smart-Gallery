...
function handleDrawStart(e) {
    ...
    if (state.isDrawingMode) {
        // PREVENT default browser image drag-and-drop
        e.preventDefault();
        ...
        // Add a massive box-shadow to dim the rest of the image outside the box
        elements.lightboxDrawingOverlay.style.boxShadow = '0 0 0 9999px rgba(0,0,0,0.6)';
